...
class PreintegrationExample(object):
    ...
    def run(self, T=1):
        ...
        for i, t in enumerate(np.arange(0, T, self.dt)):
            measuredOmega = self.runner.measuredAngularVelocity(t) # [1,3]
            measuredAcc = self.runner.measuredSpecificForce(t) # [1,3] in m/s2
            if i % 25 == 0: # accumulate 25 values
                print(f't:{t}, ome:{type(measuredOmega)}, acc:{measuredAcc.shape}');break
